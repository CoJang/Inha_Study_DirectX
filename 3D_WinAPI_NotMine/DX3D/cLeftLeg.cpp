...
void cLeftLeg::Setup()
{
	...
	{
		m_vecVertex[0].t.x = static_cast<float>(4) / 64;
		m_vecVertex[0].t.y = static_cast<float>(32) / 32;
		m_vecVertex[1].t.x = static_cast<float>(4) / 64;
		m_vecVertex[1].t.y = static_cast<float>(20) / 32;
		m_vecVertex[2].t.x = static_cast<float>(8) / 64;
		m_vecVertex[2].t.y = static_cast<float>(20) / 32;

		m_vecVertex[3].t.x = static_cast<float>(4) / 64;
		m_vecVertex[3].t.y = static_cast<float>(32) / 32;
		m_vecVertex[4].t.x = static_cast<float>(8) / 64;
		m_vecVertex[4].t.y = static_cast<float>(20) / 32;
		m_vecVertex[5].t.x = static_cast<float>(8) / 64;
		...
		m_vecVertex[7].t.x = static_cast<float>(12) / 64;
		...
		m_vecVertex[10].t.x = static_cast<float>(12) / 64;
		m_vecVertex[10].t.y = static_cast<float>(32) / 32;
		m_vecVertex[11].t.x = static_cast<float>(12) / 64;
		m_vecVertex[11].t.y = static_cast<float>(20) / 32;

		m_vecVertex[12].t.x = static_cast<float>(0) / 64;
		m_vecVertex[12].t.y = static_cast<float>(32) / 32;
		m_vecVertex[13].t.x = static_cast<float>(0) / 64;
		m_vecVertex[13].t.y = static_cast<float>(20) / 32;
		m_vecVertex[14].t.x = static_cast<float>(4) / 64;
		m_vecVertex[14].t.y = static_cast<float>(20) / 32;

		m_vecVertex[15].t.x = static_cast<float>(0) / 64;
		m_vecVertex[15].t.y = static_cast<float>(32) / 32;
		m_vecVertex[16].t.x = static_cast<float>(4) / 64;
		m_vecVertex[16].t.y = static_cast<float>(20) / 32;
		m_vecVertex[17].t.x = static_cast<float>(4) / 64;
		m_vecVertex[17].t.y = static_cast<float>(32) / 32;

		m_vecVertex[18].t.x = static_cast<float>(8) / 64;
		m_vecVertex[18].t.y = static_cast<float>(32) / 32;
		m_vecVertex[19].t.x = static_cast<float>(8) / 64;
		m_vecVertex[19].t.y = static_cast<float>(20) / 32;
		m_vecVertex[20].t.x = static_cast<float>(12) / 64;
		m_vecVertex[20].t.y = static_cast<float>(20) / 32;

		m_vecVertex[21].t.x = static_cast<float>(8) / 64;
		m_vecVertex[21].t.y = static_cast<float>(32) / 32;
		m_vecVertex[22].t.x = static_cast<float>(12) / 64;
		m_vecVertex[22].t.y = static_cast<float>(20) / 32;
		m_vecVertex[23].t.x = static_cast<float>(12) / 64;
		m_vecVertex[23].t.y = static_cast<float>(32) / 32;

		m_vecVertex[24].t.x = static_cast<float>(4) / 64;
		m_vecVertex[24].t.y = static_cast<float>(20) / 32;
		m_vecVertex[25].t.x = static_cast<float>(4) / 64;
		...
		m_vecVertex[27].t.x = static_cast<float>(4) / 64;
		...
		m_vecVertex[30].t.x = static_cast<float>(8) / 64;
		m_vecVertex[30].t.y = static_cast<float>(16) / 32;
		m_vecVertex[31].t.x = static_cast<float>(8) / 64;
		m_vecVertex[31].t.y = static_cast<float>(20) / 32;
		m_vecVertex[32].t.x = static_cast<float>(12) / 64;
		m_vecVertex[32].t.y = static_cast<float>(20) / 32;

		m_vecVertex[33].t.x = static_cast<float>(8) / 64;
		m_vecVertex[33].t.y = static_cast<float>(16) / 32;
		m_vecVertex[34].t.x = static_cast<float>(12) / 64;
		m_vecVertex[34].t.y = static_cast<float>(20) / 32;
		m_vecVertex[35].t.x = static_cast<float>(12) / 64;
