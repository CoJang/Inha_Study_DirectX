...
MyVector3 MyVector3::TransformCoord(MyVector3& vec, MyMatrix& mat)
{
	...
	moved.x = vec.x * mat[0][0] + vec.y * mat[1][0] + vec.z * mat[2][0] + mat[3][0];
	moved.y = vec.x * mat[0][1] + vec.y * mat[1][1] + vec.z * mat[2][1] + mat[3][1];
	moved.z = vec.x * mat[0][2] + vec.y * mat[1][2] + vec.z * mat[2][2] + mat[3][2];
...
{
	MyVector3 moved = vec;
	moved.x = vec.x * mat[0][0] + vec.y * mat[0][1] + vec.z * mat[0][2];
	moved.y = vec.x * mat[1][0] + vec.y * mat[1][1] + vec.z * mat[1][2];
	moved.z = vec.x * mat[2][0] + vec.y * mat[2][1] + vec.z * mat[2][2];
