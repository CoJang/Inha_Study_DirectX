...
void BCRightLeg::Init(D3DXVECTOR3 pos, D3DXVECTOR3 scale, D3DXCOLOR color)
{
...
void BCRightLeg::Update(float delta)
{
	Box::Update(delta);
}

void BCRightLeg::Draw(float delta)
{
	Box::Draw(delta);
}
