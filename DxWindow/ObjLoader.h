...
public:
	...
	void SetVertices(OUT vector<PNT_VERTEX> & vertices) { m_vecVertex = vertices; }
	vector<PNT_VERTEX> & GetVertices() { return m_vecVertex; }

	void SetMaterialTexture(cMtlTex* mtltex) { m_pMtlTex = mtltex; }
	cMtlTex* GetMaterialTexture() { return m_pMtlTex; }

	vector<PNT_VERTEX> & GetVertex() { return m_vecVertex; }
};
